...
Les adresses IPs voisines sur une route (ex. A1 et R11; R12 et R21; R22 et C1) font partie d'un même sous-réseau (dans l'exemple, 3 sous-réseaux). Comme dans cet exemple nous n'avons besoin que de 2 adresses IP par sous-réseaux, on utilise le masque 255.255.255.252 pour chacun. Les adresses IP de A1 et R11 seront donc très proches (ex.: 90.198.14.2 et 90.198.14.1), tout comme celles de R12 et R21 (90.198.14.254 et 90.198.14.253), et celles de R22 et C1 (90.198.14.5 et 90.198.14.6). Si un des sous-réseaux avait plus d'appareils, nécessitant alors plus d'adresses, il utiliserait un masque différent. Dans les exercices proposés par 42, il arrive qu'une plage plus grande soit attribuée, même s'il n'y a que 2 appareils. En entreprise, cela pourrait arriver si on envisageait de potentiellement rajouter des machines à l'avenir: on a ainsi plus de marge au cas où.

Les routes partant d'internet contiennent généralement (du moins dans les exercices proposés) au moins un byte à 0 (ex.: 166.151.215.0/24). Leur masque se calcule en fonction de combien de bytes sont à 0: si seulement le dernier est à 0, on calcule 32 - 1x8, soit 24. Si les deux derniers sont à 0 (ex. : 166.151.0.0/16), on calcule 32 - 2x8, soit 16. J'imagine qu'il est possible d'avoir des entre-deux: pour mieux comprendre cette option, penchons-nous sur les routes partant des routeurs.

Les routes partant des routeurs, du moins dans les exercices proposés, ont moins tendance à contenir des bytes à 0. Si il y a plusieurs routes qui partent du même routeur pour aller vers des adresses assez proches (par ex.: 166.151.215.192/30 et 166.151.215.128/26), le premier byte différent entre les deux indique à partir de combien les adresses atteignables par cette route commencent, par ex.: 166.151.215.129 (le premier byte différent + 1 au minimum), avec un masque de /26, soit 255.255.255.192, impliquant que la dernière adresse disponible de cette plage est 166.151.215.191 (129 + 62 adresses utilisables). L'autre route amènerait à la plage d'adresses 166.151.215.193 à 166.151.215.194, car elle a un masque de /30, soit 255.255.255.252, ne laissant que 2 adresses possibles devant commencer après 192.

Deux ordinateurs d'un même sous-réseau doivent avoir des adresses IP qui se suivent, en respectant les masques de chacun, même s'ils sont séparés par un routeur. Si le premier a un masque de 255.255.255.192, et un sous-reseau à 150.152.40.128, la plage de 128 à 128 + 64 est prise, la plage du 2ème ordinateur commencera donc à 192.
